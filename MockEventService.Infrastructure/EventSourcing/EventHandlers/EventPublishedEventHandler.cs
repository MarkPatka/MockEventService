...
public sealed class EventPublishedDomainEventHandler : INotificationHandler<EventPublished>
{
    ...
    public async Task Handle(EventPublished notification, CancellationToken cancellationToken)
    {
        ...
        _logger.LogDebug("Published EventPublished to Kafka for EventId {EventId}", notification.EventId.Value);
    }
}